...
/>
    <div class="topnav" id="myTopnav">
        ...
        <a href="http://localhost/project/User/Rent.php">Rent</a>
    ...
    <?php 
        ...
        if(!isset($_GET["submit_button"])){ 
            ...
            $city = isset($_GET["search"])? $_GET["search"]:"";
                ...
                {
                    echo '<div name="spacer" style="margin-top: 3%"></div>';
                    $result_res = mysqli_query($conn,"select offered_for,Price,type_of_property,Nearest_railway,Nearest_airport,nearest_hospital,address,description , img_path from Property where city = '$city' ");
                    $temp;
                    while($temp = mysqli_fetch_assoc($result_res))
                    {   
                        
                        $temp_path='../User/'.$temp['img_path'];
