...
/>
    <div class="topnav" id="myTopnav">
        ...
        <a style="background-color:black;color:white;">PG</a>
    ...
    <?php
            ...
            if(isset($_GET["submit_button"])){    
                ...
                {
                    $result_res = mysqli_query($conn,"select Price,type_of_property,Nearest_railway,Nearest_airport,nearest_hospital,address,description , img_path from Property where city = '$city' AND offered_for = 'PG' ");
                    $temp;
